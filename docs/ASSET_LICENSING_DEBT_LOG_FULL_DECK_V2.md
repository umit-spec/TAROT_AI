...
| V2-D007 | Per-file binary verification | CLOSED | Binary ingest | 79-file SHA-256/bytes/dimension inventory generated and committed: `assets/tarot-cards-v2/provenance-manifest.json` → `assets`. Binary commit SHA: this commit. |
